...
\end{equation}
Công thức này là dạng cơ bản của thuật toán Weiszfeld \cite{Weiszfeld1937}. Mỗi vòng lặp chỉ cần tính một trung bình có trọng số; các điểm gần nghiệm hiện tại hơn nhận trọng số lớn hơn.
